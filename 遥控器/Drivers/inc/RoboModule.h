...
extern short Real_Current_Value[1];
extern short Real_Velocity_Value[1];
extern long Real_Position_Value[1];
extern char Real_Online[1];
extern char Real_Ctl1_Value[1];
extern char Real_Ctl2_Value[1];
